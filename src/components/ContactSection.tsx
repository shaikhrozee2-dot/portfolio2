    ...
    <section id="contact" className="py-24 md:py-32" ref={ref}>
      <div className="section-container">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            <p className="text-xs uppercase tracking-[0.3em] text-primary font-mono mb-3">Get In Touch</p>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Let's build something <span className="font-display italic text-gradient">amazing</span>
            </h2>
            <p className="text-muted-foreground mb-10 max-w-md leading-relaxed">
              Have a project in mind? Whether it's a RAG chatbot, computer vision pipeline, or an AI-powered application — let's make it happen.
            </p>
